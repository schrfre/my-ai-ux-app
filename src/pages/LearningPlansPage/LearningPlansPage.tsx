  ...
  return (
    <div className={styles.container}>
      <div className={styles.hero}>
        <h1>Lernpläne</h1>
        <p>Verwalten Sie Ihre erstellten Lernpläne</p>
      </div>
          ...
          <>
            <div className={styles.searchBar}>
              <input
                ...
                placeholder="Lernpläne durchsuchen..."
            ...
            <div className={styles.plansGrid}>
              {filteredPlans.length === 0 ? (
                <EmptyState
                  title="Keine Lernpläne gefunden"
                  description={searchTerm ? "Versuchen Sie andere Suchbegriffe" : "Sie haben noch keine Lernpläne erstellt"}
                />
              ) : (
                                ...
                                <div className={styles.statInfo}>
                                  ...
                                  <span>
                                    {plan.chapters.length > 0 
                                      ? plan.chapters.map(ch => ch.difficulty).filter(d => d === 'Schwer').length + '/5'
                                      : 'N/A'}
                                  </span>
                                </div>
                              </div>
